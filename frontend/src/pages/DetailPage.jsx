...
function DetailPage() {
  ...
  // Get program data and student data passed from results page
  ...
  const handleShowPrerequisites = (course) => {
...
function CoursesTab({ program, onShowPrerequisites }) {
...
function ProgressTab({ program, studentData }) {
  // Calculate progress
...
function CourseDetailCard({ course, onShowPrerequisites }) {
